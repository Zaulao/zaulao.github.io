...
For this page to be the content delivered by default by the reverse proxy, it is necessary that I add the environment variable "DEFAULT_HOST: default.home.lan" in the reverse proxy docker-compose, as indicated in the [documentation](https://github.com/nginx-proxy/nginx-proxy/tree/main/docs#default_root).
